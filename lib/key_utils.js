...
function random32ByteBuffer() {
    ...
    var getRandomBytes = new Promise(function (resolve, reject) {
        randomBytes(32, function (error, bytes) {
            if (error) {
                reject(error);
            } else {
    ...
    var getBrowserEntropy = browserEntropy();
...
function browserEntropy() {
    return new Promise(function (resolve, reject) {
        randomBytes(101, function (error, byte) {
            if (error) {
                reject(error);
            } else {
                var entropyStr = Array(byte.toString('hex')).join();
                try {
